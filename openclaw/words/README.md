...
- A tick every two hours may send one quiz between 5pm and 9pm Pacific, then waits a random 3–5 days. Diary uses the same window on its own clock, so they sometimes land on the same evening and sometimes do not.
